...
- $X \rightarrow Y: \quad Y=f(X, U_Y)$ mit einer Funktion $f(\cdot)$ und exogenen $U$. 
...
| Assoziation $X$ uo $Y$     | Kausal                          | Nich-Kausal                    | Keine                       
...
**Beispiel**: Sonnencreme  $\leftarrow$ Sonnenschein  $\rightarrow$ Eis
  ...
  - Wenn ich Sonnencreme kenne, lerne ich über Sonnenschein etwas über Eis. Unbedingt (marginal) sind Sonnencreme und Eis nicht unabhängig. Formal: $X \not\!\perp\!\!\!\perp Y$
  
  - Wenn ich Sonnenschein kenne lerne ich nichts neues über Eis wenn ich Sonnencreme kenne. Bedingt Sonnenschein sind sind Sonnencreme und Eis unabhängig. Formal: $X{\perp\!\!\!\perp}Y|C$
...
**Beispiel**: Wochenenende  $\rightarrow$ Ausschlafen  $\leftarrow$ Ferien
  ...
  - Übers Wochenden lerne ich nichts über Ferien. Unbedingt (marginal) sind Wochenende und Ferien unabhängig. Formal: $X{\perp\!\!\!\perp}Y$
  
  - Wenn ich ausschlafen kann und es ist kein Wochenende, lerne ich etwas über Ferien (es müssen welche sein). Bedingt Ausschlafen sind die Variablen nicht unabhängig. Formal: $X \not\!\perp\!\!\!\perp Y|C$
...
- $X \rightarrow C \rightarrow Y$: $C$ ist ein Mediator zwischen $X$ und $Y$.

- $X \leftarrow C \rightarrow Y$: $C$ ist eine gemeinsame Ursache von $X$ und $Y$.

- $X \rightarrow C \leftarrow Y$ : $C$ ist eine gemeinsam Wirkung von $X$ und $Y$.
...
- Alle Variablen mit einem Pfeil von $Z$ heißen Kinder von $Z$.
...
Was bedeutet dieses Modell für das Schätzen des kausalen Effektes des Geschlechts auf das Gehalt?
