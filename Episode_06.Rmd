...
params:
  ...
  semester: "Episode 6: EDA - Vergleich numerischer Variable"   # Enter HERE the date/semester/term
...
gf_boxplot(B_SATS_Kompetenz ~ F07_Aktien, 
           data = SATS_BFI) %>%
  gf_labs(title="SATS-36 und Öknomisches Wissensfrage",
          x="Öknomisches Wissensfrage", 
