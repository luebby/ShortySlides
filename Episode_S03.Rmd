...
- Inferenzstatistik: Konfidenzinterval


<br>

**Hinweis**: Dies ist eine Fortsetzung vom Special 2.
...
Das Ergebnis unser zufälligen Stichprobe:
...
- *Angel*: Ein Punktschätzer schätzt durch einen einzigen Wert, den der Anteil der Stichprobe.

- *Netz*: Das Resampling Intervall gibt einen Bereich an, in dem wir beim wiederholten *angeln* den Anteil gefischt haben, z.B. in $95\,\%$.
